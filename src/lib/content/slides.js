...
export const SLIDES = [
  {
    ...
    "content": {
      ...
      "title": "Liapor",
      "subtitle": "BUILDING THE FUTURE'S FOUNDATION",
      "description": "",
      "stickers": []
    },
    "config": {
  ...
  },
  {
    ...
    "template": "CheckerSlide",
    "content": {
      "title": "CMS a technologie. Web, který zítra nezestárne.",
  ...
  },
  {
    ...
    "template": "HeroSlide",
    "content": {
      "title": "Od čeho se odrážíme.",
      "subtitle": "Potřeby. Pilíře. Základ pro návrh."
    },
    "config": {
      "backgroundColor": "bg-ant-yellow",
      "textColor": "text-black",
  ...
  },
  {
    ...
    "template": "CheckerSlide",
    "content": {
      "title": "Klíčové závěry I.",
      "items": [
        "Jednotný design — jeden vizuální jazyk napříč všemi 13 trhy. Žádné lokální odbočky.",
        "Stromová struktura — jasná, sdílená architektura obsahu. Každá země si zapne svoje.",
        "Materiál v hlavní roli — výhody liaporitu viditelné na první pohled. Ne schované v textu.",
        "Reference jako argument — ne galerie, ale důkaz. Projekty, které přesvědčí."
      ]
    },
    "config": {
      "backgroundColor": "bg-black",
  ...
  },
  {
    ...
    "template": "CheckerSlide",
    "content": {
      "title": "Klíčové závěry II.",
      "items": [
        "Jsme experti — poradíme vám — web jako poradce, ne jen katalog. Nezávazná konzultace = sběr leadů.",
        "Architekti & projektanti — pokročilá sekce ke stažení, technická dokumentace na dosah.",
        "Provázání aplikací — produkty, aplikace a reference propojené. Zákazník vždy najde cestu.",
        "Zelená firma — udržitelnost jako součást příběhu značky, ne jako záložka v menu."
      ]
    },
    "config": {
      "backgroundColor": "bg-black",
